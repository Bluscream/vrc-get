...
pub(crate) fn handlers() -> impl Fn(Invoke) -> bool + Send + Sync + 'static {
    generate_handler![
        ...
        environment::packages::environment_fetch_repository_info,
        ...
        environment::backups::environment_delete_backup,
        environment::backups::environment_read_backup_metadata,
        ...
        project::project_close_unity,
        project::project_kill_unity,
